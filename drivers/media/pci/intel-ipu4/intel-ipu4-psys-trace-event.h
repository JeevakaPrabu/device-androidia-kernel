...
#if !defined(INTEL_IPU4_PSYS_TRACE_EVENT_H) || defined(TRACE_HEADER_MULTI_READ)
#define INTEL_IPU4_PSYS_TRACE_EVENT_H

#include <linux/tracepoint.h>

TRACE_EVENT(ipu4_psys_sof_seqid,
...
TRACE_EVENT(ipu4_psys_perf_reg,
...
#endif /* INTEL_IPU4_PSYS_TRACE_EVENT_H */

#undef TRACE_INCLUDE_PATH
#undef TRACE_INCLUDE_FILE
#define TRACE_INCLUDE_PATH .
#define TRACE_INCLUDE_FILE  intel-ipu4-psys-trace-event
