...
const u32 intel_ipu_fw_psys_cell_types[IPU_FW_PSYS_N_CELL_ID] = {
...
const u16 intel_ipu4_num_dev_channels[IPU_FW_PSYS_N_DEV_CHN_ID] = {
...
const uint16_t intel_ipu_fw_psys_mem_size[IPU_FW_PSYS_N_MEM_ID] = {
...
const enum intel_ipu_mem_id
intel_ipu_fw_psys_cell_mem
