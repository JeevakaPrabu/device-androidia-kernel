	...
	const vied_nci_resource_bitmap_t	bitmap)
{
	...
	if (manifest != NULL && dfm_type_id < VIED_NCI_N_DEV_DFM_ID) {
...
EXIT:
	if (NULL == manifest || dfm_type_id >= VIED_NCI_N_DEV_DFM_ID) {
		IA_CSS_TRACE_0(PSYSAPI_STATIC, WARNING,
