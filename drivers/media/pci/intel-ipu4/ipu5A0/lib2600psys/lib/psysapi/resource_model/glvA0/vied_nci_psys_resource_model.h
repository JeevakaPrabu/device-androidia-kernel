...
typedef enum {
	...
	VIED_NCI_VMEM1_ID,     /* ISP1 VMEM */
	VIED_NCI_VMEM2_ID,     /* ISP2 VMEM */
	...
	VIED_NCI_BAMEM1_ID, /* ISP1 BAMEM */
	VIED_NCI_BAMEM2_ID, /* ISP2 BAMEM */
	VIED_NCI_DMEM0_ID, /* SPC0 Dmem */
	VIED_NCI_DMEM1_ID, /* SPP0 Dmem */
	VIED_NCI_DMEM2_ID, /* SPP1 Dmem */
	VIED_NCI_DMEM3_ID, /* ISP0 Dmem */
	VIED_NCI_DMEM4_ID, /* ISP1 Dmem */
	VIED_NCI_DMEM5_ID, /* ISP2 Dmem */
	VIED_NCI_PMEM0_ID, /* ISP0 PMEM */
	VIED_NCI_PMEM1_ID, /* ISP1 PMEM */
	VIED_NCI_PMEM2_ID, /* ISP2 PMEM */
	VIED_NCI_N_MEM_ID
} vied_nci_mem_ID_t;
...
#define VIED_NCI_GMEM_TYPE_ID VIED_NCI_VMEM_TYPE_ID
...
#define VIED_NCI_TRANSFER_VMEM0_MAX_SIZE	(0x0400) /* Transfer VMEM0 words */
#define VIED_NCI_TRANSFER_VMEM1_MAX_SIZE	(0x0400) /* Transfer VMEM1 words */
...
#define VIED_NCI_BAMEM1_MAX_SIZE		(0x0800)
#define VIED_NCI_BAMEM2_MAX_SIZE		(0x0800)
...
#define VIED_NCI_DMEM4_MAX_SIZE			(0x1000) /* TODO: verify the size */
#define VIED_NCI_DMEM5_MAX_SIZE			(0x1000) /* TODO: verify the size */
#define VIED_NCI_PMEM0_MAX_SIZE			(0x0500) /* TODO: verify the size */
#define VIED_NCI_PMEM1_MAX_SIZE			(0x0500) /* TODO: verify the size */
#define VIED_NCI_PMEM2_MAX_SIZE			(0x0500) /* TODO: verify the size */
 ...
 */
#define VIED_NCI_DFM_BB_FULL_PORTS_MAX_SIZE			(32)
#define VIED_NCI_DFM_LB_FULL_PORTS_MAX_SIZE			(32)
#define VIED_NCI_DFM_BB_EMPTY_PORTS_MAX_SIZE		(32)
#define VIED_NCI_DFM_LB_EMPTY_PORTS_MAX_SIZE		(32)
