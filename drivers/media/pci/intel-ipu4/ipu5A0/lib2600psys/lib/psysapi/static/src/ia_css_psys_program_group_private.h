...
#if HAS_DFM
#define N_DFM_RESOURCES VIED_NCI_N_DEV_DFM_ID
#else
#define N_DFM_RESOURCES 0
#endif
...
#define SIZE_OF_PROGRAM_MANIFEST_STRUCT_IN_BITS \
	...
	+ (VIED_NCI_RESOURCE_BITMAP_BITS * N_DFM_RESOURCES) \
	+ (VIED_NCI_RESOURCE_BITMAP_BITS * N_DFM_RESOURCES) \
	...
	+ (IA_CSS_UINT8_T_BITS * N_DFM_RESOURCES) \
...
#endif
	/* A bitmap indicating cells in the program
	 * the bitmap is created following the order defined
	 * in vied_nci_cell_ID_t (vied_nci_psys_resource_model.h)
	 */
	vied_nci_resource_bitmap_t cells_bitmap;
	/**< Size of this structure */
	uint16_t size;
...
#endif
	/* TODO: Cell_id and cell_type_id can be deprecated
	 */
